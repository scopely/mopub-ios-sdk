...
- (void)requestInterstitialWithCustomEventInfo:(NSDictionary *)info
{
    ...
    CoreLogType(WBLogLevelInfo, WBLogTypeAdFullPage, @"Requesting Chartboost interstitial.");
...
- (void)showInterstitialFromRootViewController:(UIViewController *)rootViewController
{
    if ([[MPChartboostRouter sharedRouter] hasCachedInterstitialForLocation:self.location]) {
        CoreLogType(WBLogLevelDebug, WBLogTypeAdFullPage, @"Chartboost interstitial will be shown.");
        ...
        CoreLogType(WBLogLevelError, WBLogTypeAdFullPage, @"Failed to show Chartboost interstitial.");
...
{
    CoreLogType(WBLogLevelInfo, WBLogTypeAdFullPage, @"Successfully loaded Chartboost interstitial. Location: %@", location);
...
{
    CoreLogType(WBLogLevelFatal, WBLogTypeAdFullPage, @"Failed to load Chartboost interstitial. Location: %@", location);
...
{
    CoreLogType(WBLogLevelDebug, WBLogTypeAdFullPage, @"Chartboost interstitial was dismissed. Location: %@", location);
...
{
    CoreLogType(WBLogLevelDebug, WBLogTypeAdFullPage, @"Chartboost interstitial was clicked. Location: %@", location);
